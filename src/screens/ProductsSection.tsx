  ...
  return (
    <section className="w-full bg-black py-20 px-4 md:px-0">
      <div className="container mx-auto flex flex-col items-center">
        {/* Heading */}
        <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500 mb-4 text-center drop-shadow-lg">
          Products
        </h2>
        <span className="inline-block px-4 py-1 mb-8 rounded-full bg-[#232526]/70 text-white text-base font-semibold border border-primary/40 shadow shadow-primary/20 backdrop-blur-md">
          <span className="mr-2">🚀</span> Coming Soon
        </span>
        {/* Description */}
        <p className="font-light text-lg md:text-2xl text-neutral-400 max-w-2xl text-center mb-12">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 justify-center items-center">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="absolute inset-0 pointer-events-none rounded-2xl border border-white/10" style={{boxShadow: '0 0 32px 0 rgba(239,68,68,0.15)'}} />
